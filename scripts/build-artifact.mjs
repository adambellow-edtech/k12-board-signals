...
const js = ['js/analytics.js', 'js/flags.js', 'js/api.js', 'js/onboarding.js', 'js/ambient.js', 'js/data.js', 'js/state.js', 'js/puzzles.js', 'js/avatar.js', 'js/world.js', 'js/screens.js', 'js/main.js']
  .map(read).join('\n\n');
